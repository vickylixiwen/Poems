...
public class PoemDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME = "learning"; //DB name
    ...
    private void updateMyDatabase(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (oldVersion < 1) {
            ...
            insertPoem(db, 1001, "咏鹅", "骆宾王",
                    "鹅，鹅，鹅，\n曲项向天歌，\n白毛浮绿水，\n红掌拨清波。", "", 1, true);
            insertPoem(db, 3001, "江上渔者", "北宋 范仲淹", "江上往来人，\n但爱鲈鱼美。\n" +
                            "君看一叶舟，\n出没风波里。\n",
                    "释义：\n1.渔者：捕鱼的人。\t" +
                            "2.但：只\t" +
                            "3.爱：喜欢\t" +
                            ...
                            "8.风波：波浪。\n" +
                            "整体赏析:\n" +
                            "诗中饱含了诗人对那些驾着一叶扁舟出没于滔滔风浪中的渔民的关切与同情之心，也表达了诗人对“只爱鲈鱼美”的江上人规劝之意。在江上和舟中两种环境、“来往”和“出没”两种动态、吃鱼人和捕鱼人两种生活的强烈对比中，显示出了诗人的意旨所在。", 3, false);
            insertPoem(db, 3002, "赠刘景文", "北宋 苏轼", "荷尽已无擎雨盖⑵，\n" +
                            "菊残犹有傲霜枝⑶。\n" +
                            "一年好景君须记⑷，\n" +
                            "正是橙黄橘绿时⑸。\n",
            ...
            insertPoem(db, 3003, "塞下曲", "唐 卢纶",
                    ...
                    3, true);
            insertPoem(db, 3004, "忆江南", "唐 白居易",
                    "江南好，\n风景旧曾谙。\n日出江花红胜火，\n春来江水绿如蓝，\n能不忆江南？",
                    "译文： \n" +
                            "江南的风景多么美好，风景久已熟悉。春天到来时，太阳从江面升起，把江边的鲜花照得比火红，碧绿的江水绿得胜过蓝草。怎能叫人不怀念江南？\n" +
                            "整体赏析: \n" +
                            "忆江南，本为唐教坊曲名，后用作词牌名。", 3, true);
            insertPoem(db, 3005, "江南春", "唐 杜牧",
                    "千里莺啼绿映红，\n水村山郭酒旗风。\n南朝四百八十寺，\n多少楼台烟雨中",
                    " 释义：\n莺啼：即莺啼燕语。\t" +
                            "郭：外城。此处指城镇。\t" +
                            "酒旗：一种挂在门前以作为酒店标记的小旗。\t" +
            ...
            insertPoem(db, 3006, "蜂", "唐 罗隐", "不论平地与山尖，\n无限风光尽被占。\n" +
                            "采得百花成蜜后，\n为谁辛苦为谁甜。",
                    "释义：\n⑴山尖：山峰。\t" +
